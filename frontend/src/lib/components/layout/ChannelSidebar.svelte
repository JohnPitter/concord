<script lang="ts">
  ...
  let { serverName, channels, activeChannelId, onSelectChannel }: {
    serverName: string
    channels: Channel[]
    ...
    <div class="flex items-center gap-2 rounded-md px-2 py-1.5">
      ...
      <div class="flex gap-1">
        <Tooltip text="Mute" position="top">
          <button aria-label="Mute" class="rounded-md p-1.5 text-void-text-secondary transition-colors hover:bg-void-bg-hover hover:text-void-text-primary cursor-pointer">
        ...
        <Tooltip text="Deafen" position="top">
          <button aria-label="Deafen" class="rounded-md p-1.5 text-void-text-secondary transition-colors hover:bg-void-bg-hover hover:text-void-text-primary cursor-pointer">
            <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
